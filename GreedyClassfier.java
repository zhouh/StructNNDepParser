...
public class GreedyClassfier {
   ...
   * @param preComputed
   */
  public GreedyClassfier(Config config, double[][] E, double[][] W1, double[] b1, double[][] W2, List<Integer> preComputed) {
   ...
   * @param preComputed
   */
  public GreedyClassfier(Config config, Dataset dataset, double[][] E, double[][] W1, double[] b1, double[][] W2,
   ...
   * backpropagation.
   *
   * @see GreedyClassfier.CostFunction
   */
  public class Cost {
